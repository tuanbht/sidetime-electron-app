...
export const textTypographyStyles = css`
...
export const openPreferencesButtonStyles = css<ButtonStyleType>`
  padding: 0px 16px;
  margin-right: 8px;
`;

export const doneButtonStyles = css<ButtonStyleType>`
...
export const doneButtonTextStyles = css`
  font-size: 16px;
  line-height: 16px;
  font-family: ${({ theme: { fonts } }) => fonts.neuzeitGrotesk};
